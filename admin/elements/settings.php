...
class JElementSettings extends JElement
{
	...
	{
		JTable::addIncludePath(JPATH_ADMINISTRATOR.DS.'components'.DS.'com_convertbapliemovins'.DS.'tables');
		...
		$link = 'index.php?option=com_convertbapliemovins&amp;view=settings&amp;task=element&amp;tmpl=component&amp;function=jSelectSettings_'.$name;
